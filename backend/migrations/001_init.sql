...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    description    TEXT COMMENT '任务描述(详情说明,可选)',
    annot_type     ENUM('shadow','light_source','reflection','exposure','filter'),
    ...
    unit_price     DECIMAL(10,2) NOT NULL COMMENT '单价(每件作业价格; 本周期佣金=提交数量*单价)',
...
CREATE TABLE IF NOT EXISTS commissions (
    ...
    task_id       BIGINT UNSIGNED NOT NULL,
    assignment_id BIGINT UNSIGNED NOT NULL,
    amount        DECIMAL(10,2) NOT NULL COMMENT '佣金=提交数量*单价(本周期)',
